<template>
  <view class="bing-countup">
    <text v-if="showHour" :style="[timeStyle]" class="bing-countup__number">
      {{ h }}
    </text>
    <text v-if="showHour" :style="[splitorStyle]" class="bing-countup__splitor">
      {{ showColon ? ':' : hourText }}
    </text>
    <text :style="[timeStyle]" class="bing-countup__number">{{ i }}</text>
    <text :style="[splitorStyle]" class="bing-countup__splitor">

<template>
	<view class="container">
		...
		<view class="carul disflex5">
			...
			<image src="../../static/image/arrow_03.png" mode="widthFix" class="arrimg"></image>
		</view>
		<!-- 充电汽车切换 弹框 -->
		<pop ref="pop" direction="up" :is_close="true" :is_mask="true" :width="100" height="fit-content" :maskFun="true" @watchOpen="watchOpen" @watchClose="watchClose">
			<view class="tcwarp">
		...
		<!-- 汽车图片 -->
		<view class="carshow"><image src="../../static/image/car.png" mode="widthFix"></image></view>
		<!-- 充电计时 -->
		<view class="Timesul">
			<uni-countdown :show-day="false" :font-size="40" :hour="0" :minute="12" :second="12" class="cTimes" style="justify-content:center"/>
		...
		<view class="dylist">
			<view class="leader">
				<view class="ltitle">
					<view @tap="changeShowType(1)" :class="showType == 1 ? 'activeContentA' : ''"><view>电压</view></view>
					<view @tap="changeShowType(2)" :class="showType == 2 ? 'activeContentA' : ''"><view>功率</view></view>
					<view @tap="changeShowType(3)" :class="showType == 3 ? 'activeContentA' : ''"><view>电流</view></view>
				</view>
			</view>
			<view class="uchart" v-if="showType == 1">
				...
				<qiun-data-charts type="area" :opts="optsDY" :ontouch="true" :chartData="chartDataDY" />
			</view>
			<view class="uchart" v-if="showType == 2">
				...
				<qiun-data-charts type="area" :opts="optsGL" :ontouch="true" :chartData="chartDataGL" />
			</view>
			<view class="uchart" v-if="showType == 3">
				...
				<qiun-data-charts type="area" :opts="optsDL" :ontouch="true" :chartData="chartDataDL" />
			</view>
		</view>
	...
	data() {
		...
		return {
			...
			optsDY: {
				color: ['#FAC858', '#EE6666'],
				padding: [0, 10, 0, 0],
				legend: { show: true, position: 'top', float: 'right', itemGap: 10, padding: 5, lineHeight: 0 }, //小标题
